        ...
        <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-[13px] leading-6 text-[#9ff7f0]">
              Free stays on non-AI verification modules. Pro adds Alibaba fingerprinting without TEE, and Protocol unlocks full compute, TEE, AWS Nitro Fortress, selected partner SDK wrappers, and all marketplace modules.
            </p>
          </div>
        </div>
