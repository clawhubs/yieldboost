...
const navStats = [
  { icon: Users, value: "1,247", label: "Users Optimized", sublabel: "↑ 12 in last hour" },
  { icon: DollarSign, value: "$2.4M", label: "TVL Managed", sublabel: "↑ $180k today" },
  { icon: Cpu, value: "18,392", label: "Compute Jobs", sublabel: "↑ 184 today" },
  { icon: UserRound, value: "342", label: "New Accounts", sublabel: "↑ 27 this week" },
  { icon: Shield, value: "12", label: "Live Strategies", sublabel: "Across 12 chains" },
] as const;
...
const whyOg = [
  {
    ...
    line1: "Petabyte scale",
    line2: "Low cost, high throughput",
  },
  {
    icon: ShieldCheck,
    title: "VERIFIABLE COMPUTE",
    line1: "ZK-proofs on-chain",
    line2: "Trustless & verifiable",
  },
  {
    icon: Cpu,
    title: "BUILT FOR AI AGENTS",
    line1: "Decentralized infra",
    line2: "Designed for scale",
  },
] as const;
...
function HeroChart() {
  return (
    <div data-testid="yield-chart" className="relative h-[176px]">
      ...
      <div className="absolute right-2 top-0 text-[14px] font-semibold text-white">23.84%</div>
      <div className="absolute left-0 top-[128px] text-[11px] text-white/90">12.38%</div>
...
export default function DashboardView() {
  ...
  return (
    <>
      <section className="p-[10px] md:h-full">
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-5">
                    <div className="border-r border-[#182028] pr-4">
                      ...
                      <div className="mt-2 text-[26px] font-semibold text-[#22e070]">+23.61%</div>
                      <div className="mt-1 text-[13px] text-[#29e072]">
                        +$2,356.41 <span className="text-[#d8e1e9]">/ year</span>
                      </div>
                    </div>
                    <div>
                      <div className="text-[11px] uppercase tracking-[0.08em] text-[#a9b5c0]">
                      ...
                      <div className="mt-2 text-[26px] font-semibold text-white">23.84%</div>
              ...
              {portfolioStats.map((item, index) => (
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className={`flex h-11 w-11 items-center justify-center rounded-full ${index === 3 ? "bg-[#0d1b13] text-[#2fe06d]" : "bg-[#0d131a] text-[#d8e1e8]"}`}>
                      <item.icon className="h-5 w-5" />
                    </div>
                  </div>
                  <div className="mt-3 flex justify-end">
                    <MiniSpark color={index === 3 ? "#2fe06d" : "#2ad7c8"} />
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="grid gap-[10px] xl:grid-cols-[276px_minmax(0,1fr)_298px]">
              <div data-testid="before-after-card" className="yb-card rounded-[14px] px-4 py-4">
                ...
                <div className="mt-4 grid grid-cols-[1fr_42px_1fr] items-center gap-3">
                  <div className="rounded-[10px] border border-[#17351c] bg-[#0b1511] p-3">
                    ...
                    <div className="mt-2 text-[18px] font-semibold text-white">12.38%</div>
                  ...
                  <div className="rounded-[10px] border border-[#1e5d53] bg-[#0d1917] p-3">
                    ...
                    <div className="mt-2 text-[18px] font-semibold text-[#25ddd0]">23.84%</div>
                    <div className="mt-1 text-[11px] text-[#d5dde6]">AI Projected APY</div>
                  </div>
                </div>
                <div className="mt-3 grid grid-cols-3 gap-2 text-[11px]">
                  <div className="rounded-[10px] bg-[#0d1811] p-2 text-[#2fe06d]">+23.61%<div className="mt-1 text-[#cad4dd]">Improve</div></div>
                  <div className="rounded-[10px] bg-[#0d1811] p-2 text-[#2fe06d]">+$2,356.41<div className="mt-1 text-[#cad4dd]">More per year</div></div>
              ...
              <div className="yb-card rounded-[14px] px-4 py-4">
                ...
                <div className="mt-4 flex items-center justify-between text-[12px] text-[#cfd8e0]">
                  ...
                  <span>Confidence: <span className="text-[#2fe06d]">96%</span></span>
                </div>
              </div>
                ...
                <div className="mt-4 space-y-3">
                  {proofs.map((item) => (
                    <div key={item.hash} className="flex items-center justify-between gap-2">
                      ...
                      <div className="rounded-full border border-[#12453f] px-2 py-1 text-[9px] text-[#25d6c6]">
                        2X Verified on 0G
                      </div>
                    </div>
                  ))}
                </div>
                <button type="button" className="mt-4 text-[12px] text-[#25d6c6]">
                  View on 0G Explorer →
                </button>
              </div>
            ...
            <div className="grid gap-[10px] xl:grid-cols-[1.18fr_1fr_1fr]">
              ...
              <div data-testid="zerog-stats" className="yb-card rounded-[14px] px-4 py-4">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button type="button" className="text-[11px] text-[#25d6c6]">View on 0G Explorer →</button>
                </div>
          ...
          >
            ...
            <div className="mt-4 flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1 rounded-[14px] border border-[#1b242d] bg-[#0b1117] px-4 py-4">
                ...
                <div className="mt-3 text-[14px] leading-7 text-[#e6edf3]">
                  ...
                  <br />
                  <span className="text-[16px] font-semibold text-[#2fe06d]">+23.61% (+$2,356.41/year)</span>
                  <br />
                  with low risk.
                </div>
                <button
            ...
            >
              ...
              <div className="mt-2 flex items-center justify-between gap-4">
                <div className="text-[64px] font-semibold leading-none text-[#68ff7a]">23.84%</div>
      ...
      <ProofModal
        ...
        cid={proofDetails.cid}
        txHash={proofDetails.txHash}
      />
    </>
  );
}
