      ...
      {open ? (
        ...
        >
          <motion.div
            ...
            className="surface-panel teal-ring relative w-full max-w-xl overflow-hidden rounded-[28px] border border-[rgba(42,215,200,0.18)] bg-[radial-gradient(circle_at_top_right,rgba(34,221,208,0.18),transparent_38%),linear-gradient(180deg,rgba(8,16,22,0.98)_0%,rgba(4,9,14,0.98)_100%)] p-5 shadow-[0_30px_80px_rgba(0,0,0,0.55)] sm:p-6"
          >
