...
export const API_MARKETPLACE_PRODUCTS: ApiMarketplaceProduct[] = [
  {
    ...
    name: "TITAN X 10-Layer API",
    partner: "YieldBoost 0G",
    tagline: "Ten security layers moving together in one live trust path",
    description:
  ...
  },
  {
    ...
    partner: "YieldBoost 0G",
    tagline: "Layer 10 continuity sold as its own fortress module",
    description:
      "A modular fortress SDK for secure agent runtimes: AWS Nitro Enclave framing for isolated execution, a 0G TEE badge summary for attestation-style evidence, and a 0G Storage incident journal for sealed secrets, attack logs, and recovery replay history. This is the enclave continuity rail sold beside TITAN X.",
    logoPath: "/marketplace/ya-9-layer-logo.png",
    endpoint: "/api/dev/store/aws-nitro-fortress",
...
const result = await response.json();`,
  },
  {
    ...
    partner: "YieldBoost 0G",
    tagline: "Dedicated abuse-resistance module sold beside TITAN X",
    description:
